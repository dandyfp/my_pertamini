...
class Validator {
  ...
  static final insertCardIdentityNumberValidator = MultiValidator([
    requiredValidator,
    MinLengthValidator(5, errorText: 'card number must be at least 5 digits long'),
    MaxLengthValidator(20, errorText: 'card number must be at maximum 20 digits long'),
  ]);
