...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            CoreRes<dynamic>? coreRes, NetworkExceptions error)
        failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(CoreRes<dynamic>? coreRes, NetworkExceptions error)?
        failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({CoreRes<dynamic>? coreRes, NetworkExceptions error});
...
class __$$FailureCopyWithImpl<T, $Res>
  ...
  @override
  $Res call({
    Object? coreRes = freezed,
    Object? error = null,
  }) {
    return _then(_$Failure<T>(
      coreRes: freezed == coreRes
          ? _value.coreRes
          : coreRes // ignore: cast_nullable_to_non_nullable
              as CoreRes<dynamic>?,
      error: null == error
          ? _value.error
...
class _$Failure<T> implements Failure<T> {
  const _$Failure({this.coreRes, required this.error});

  @override
  final CoreRes<dynamic>? coreRes;
  @override
  final NetworkExceptions error;

  @override
  String toString() {
    return 'ApiResult<$T>.failure(coreRes: $coreRes, error: $error)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.coreRes, coreRes) || other.coreRes == coreRes) &&
            (identical(other.error, error) || other.error == error));
  }

  @override
  int get hashCode => Object.hash(runtimeType, coreRes, error);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(coreRes, error);
  }
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(
      {final CoreRes<dynamic>? coreRes,
      required final NetworkExceptions error}) = _$Failure<T>;

  CoreRes<dynamic>? get coreRes;
